...
prompt Created by Daniel on יום שלישי 23 יולי 2024
set feedback off
set define off
...
alter table CLASSROOM
  ...
  check (Capacity >= 15 AND Capacity <= 30);
...
alter table STUDENT
  add constraint CHK_GRADESHEATS_NONNEGATIVE
  check (Gradesheats >= 0);
...
alter table STUDENTCLASS
  add constraint STUDENTCLASS_STUDENTCLASS__FK foreign key (CLASS_ID)
  references CLASS (CLASS_ID) on delete cascade;
alter table STUDENTCLASS
  add foreign key (STUDENT_ID)
  references STUDENT (STUDENT_ID) on delete cascade;
...
alter table BUDGET disable constraint SYS_C008710;
prompt Disabling foreign key constraints for TEACHER...
alter table TEACHER disable constraint FK_EMPLOYEE;
prompt Disabling foreign key constraints for CLASS...
alter table CLASS disable constraint SYS_C008668;
alter table CLASS disable constraint SYS_C008669;
alter table CLASS disable constraint SYS_C008670;
prompt Disabling foreign key constraints for INVOICE...
alter table INVOICE disable constraint SYS_C008715;
prompt Disabling foreign key constraints for ORDERS...
alter table ORDERS disable constraint SYS_C008719;
alter table ORDERS disable constraint SYS_C008720;
alter table ORDERS disable constraint SYS_C008721;
prompt Disabling foreign key constraints for PAYMENT...
alter table PAYMENT disable constraint SYS_C008724;
prompt Disabling foreign key constraints for SCHEDULE...
alter table SCHEDULE disable constraint SYS_C008684;
alter table SCHEDULE disable constraint SYS_C008701;
prompt Disabling foreign key constraints for STUDENTCLASS...
alter table STUDENTCLASS disable constraint STUDENTCLASS_STUDENTCLASS__FK;
alter table STUDENTCLASS disable constraint SYS_C008700;
prompt Disabling foreign key constraints for TEACHASSIGN...
alter table TEACHASSIGN disable constraint SYS_C008693;
alter table TEACHASSIGN disable constraint SYS_C008694;
...
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (1, 'Smith', 'John', 'Professor', 1, 1500);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (2, 'Johnson', 'Jane', 'Doctor', 2, 1501);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (3, 'Williams', 'James', 'Master', 1, 1502);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (4, 'Jones', 'Patricia', 'Bachelor', 2, 1503);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (5, 'Brown', 'Robert', 'Doctor', 1, 1504);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (6, 'Davis', 'Linda', 'Master', 1, 1505);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (7, 'Miller', 'Michael', 'Professor', 1, 1506);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (8, 'Wilson', 'Barbara', 'Doctor', 3, 1507);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (9, 'Moore', 'William', 'Master', 1, 1508);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (10, 'Taylor', 'Elizabeth', 'Bachelor', 2, 1509);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (11, 'Anderson', 'David', 'Professor', 1, 1510);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (12, 'Thomas', 'Jennifer', 'Doctor', 1, 1511);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (13, 'Jackson', 'Richard', 'Master', 2, 1512);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (14, 'White', 'Maria', 'Professor', 1, 1513);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (15, 'Harris', 'Charles', 'Doctor', 1, 1514);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (16, 'Martin', 'Susan', 'Master', 2, 1515);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (17, 'Thompson', 'Joseph', 'Professor', 1, 1516);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (18, 'Garcia', 'Margaret', 'Doctor', 1, 1517);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (19, 'Martinez', 'Thomas', 'Master', 2, 1518);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (20, 'Robinson', 'Dorothy', 'Bachelor', 1, 1519);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (21, 'Clark', 'Christophe', 'Doctor', 1, 1520);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (22, 'Rodriguez', 'Nancy', 'Master', 1, 1521);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (23, 'Lewis', 'Daniel', 'Professor', 1, 1522);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (24, 'Lee', 'Karen', 'Doctor', 1, 1523);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (25, 'Walker', 'Matthew', 'Master', 1, 1524);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (26, 'Hall', 'Lisa', 'Professor', 1, 1525);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (27, 'Allen', 'Nicholas', 'Doctor', 1, 1526);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (28, 'Young', 'Sandra', 'Master', 2, 1527);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (29, 'Hernandez', 'Joshua', 'Professor', 3, 1528);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (30, 'King', 'Betty', 'Doctor', 1, 1529);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (31, 'Wright', 'James', 'Master', 2, 1530);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (32, 'Lopez', 'Donna', 'Bachelor', 3, 1531);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (33, 'Hill', 'Larry', 'Doctor', 1, 1532);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (34, 'Scott', 'Kimberly', 'Master', 2, 1533);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (35, 'Green', 'Steven', 'Professor', 3, 1534);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (36, 'Adams', 'Amy', 'Doctor', 1, 1535);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (37, 'Baker', 'Frank', 'Master', 1, 1536);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (38, 'Gonzalez', 'Carolyn', 'Professor', 1, 1537);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (39, 'Nelson', 'Philip', 'Doctor', 1, 1538);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (40, 'Carter', 'Katherine', 'Master', 2, 1539);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (41, 'Mitchell', 'Harold', 'Professor', 1, 1540);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (42, 'Perez', 'Rebecca', 'Doctor', 1, 1541);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (43, 'Roberts', 'George', 'Master', 1, 1542);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (44, 'Turner', 'Michelle', 'Bachelor', 1, 1543);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (45, 'Phillips', 'Edward', 'Doctor', 1, 1544);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (46, 'Campbell', 'Shirley', 'Master', 2, 1545);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (47, 'Parker', 'Mark', 'Professor', 3, 1546);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (48, 'Evans', 'Cynthia', 'Doctor', 1, 1547);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (49, 'Edwards', 'Paul', 'Master', 1, 1548);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (50, 'Collins', 'Laura', 'Professor', 1, 1549);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (51, 'Stewart', 'Ronald', 'Doctor', 1, 1550);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (52, 'Sanchez', 'Janet', 'Master', 1, 1551);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (53, 'Morris', 'Anthony', 'Professor', 3, 1552);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (54, 'Rogers', 'Debra', 'Doctor', 1, 1553);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (55, 'Reed', 'Kevin', 'Master', 1, 1554);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (56, 'Cook', 'Carol', 'Professor', 3, 1555);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (57, 'Morgan', 'Brian', 'Doctor', 2, 1556);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (58, 'Bell', 'Anna', 'Master', 1, 1557);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (59, 'Murphy', 'Jason', 'Professor', 3, 1558);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (60, 'Bailey', 'Ruth', 'Doctor', 1, 1559);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (61, 'Rivera', 'Justin', 'Master', 2, 1560);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (62, 'Cooper', 'Gloria', 'Bachelor', 1, 1561);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (63, 'Richardson', 'Dennis', 'Doctor', 1, 1562);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (64, 'Cox', 'Emily', 'Master', 1, 1563);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (65, 'Howard', 'Jonathan', 'Professor', 1, 1564);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (66, 'Ward', 'Martha', 'Doctor', 1, 1565);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (67, 'Torres', 'Raymond', 'Master', 2, 1566);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (68, 'Peterson', 'Christine', 'Professor', 3, 1567);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (69, 'Gray', 'Gregory', 'Doctor', 1, 1568);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (70, 'Ramirez', 'Joyce', 'Master', 2, 1569);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (71, 'James', 'Joshua', 'Professor', 3, 1570);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (72, 'Watson', 'Jacqueline', 'Doctor', 1, 1571);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (73, 'Brooks', 'Gary', 'Master', 1, 1572);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (74, 'Kelly', 'Theresa', 'Professor', 1, 1573);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (75, 'Sanders', 'Samuel', 'Doctor', 1, 1574);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (76, 'Price', 'Beverly', 'Master', 1, 1575);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (77, 'Bennett', 'Albert', 'Professor', 3, 1576);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (78, 'Wood', 'Denise', 'Doctor', 1, 1577);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (79, 'Barnes', 'Jeremy', 'Master', 1, 1578);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (80, 'Ross', 'Cheryl', 'Professor', 3, 1579);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (81, 'Henderson', 'Jack', 'Doctor', 1, 1580);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (82, 'Coleman', 'Katherine', 'Master', 2, 1581);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (83, 'Jenkins', 'Gerald', 'Professor', 3, 1582);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (84, 'Perry', 'Joan', 'Doctor', 1, 1583);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (85, 'Long', 'Aaron', 'Master', 1, 1584);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (86, 'Patterson', 'Frances', 'Professor', 3, 1585);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (87, 'Hughes', 'Terry', 'Doctor', 1, 1586);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (88, 'Flores', 'Mildred', 'Master', 2, 1587);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (89, 'Washington', 'Henry', 'Professor', 1, 1588);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (90, 'Butler', 'Diana', 'Doctor', 1, 1589);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (91, 'Simmons', 'George', 'Master', 2, 1590);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (92, 'Foster', 'Doris', 'Professor', 1, 1591);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (93, 'Gonzales', 'Arthur', 'Doctor', 1, 1592);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (94, 'Bryant', 'Julie', 'Master', 1, 1593);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (95, 'Alexander', 'Lawrence', 'Professor', 3, 1594);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (96, 'Russell', 'Heather', 'Doctor', 1, 1595);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (97, 'Griffin', 'Adam', 'Master', 1, 1596);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (98, 'Diaz', 'Ashley', 'Professor', 2, 1597);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (99, 'Hayes', 'Bruce', 'Doctor', 1, 1598);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (100, 'Myers', 'Rachel', 'Master', 2, 1599);
commit;
prompt 100 records committed...
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (101, 'Ford', 'Joe', 'Professor', 1, 1600);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (102, 'Hamilton', 'Janice', 'Doctor', 1, 1601);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (103, 'Graham', 'Roy', 'Master', 1, 1602);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (104, 'Sullivan', 'Megan', 'Professor', 1, 1603);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (105, 'Wallace', 'Roger', 'Doctor', 1, 1604);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (106, 'Woods', 'Doris', 'Master', 1, 1605);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (107, 'Cole', 'Juan', 'Professor', 1, 1606);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (108, 'West', 'Gloria', 'Doctor', 1, 1607);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (109, 'Jordan', 'Francis', 'Master', 1, 1608);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (110, 'Owens', 'Eric', 'Professor', 1, 1609);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (111, 'Reynolds', 'Evelyn', 'Doctor', 1, 1610);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (112, 'Fisher', 'Ronald', 'Master', 1, 1611);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (113, 'Ellis', 'Judith', 'Professor', 1, 1612);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (114, 'Harrison', 'Kenneth', 'Doctor', 1, 1613);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (115, 'Gibson', 'Alice', 'Master', 1, 1614);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (116, 'Mcdonald', 'Philip', 'Professor', 3, 1615);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (117, 'Cruz', 'Brenda', 'Doctor', 1, 1616);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (118, 'Marshall', 'Stephen', 'Master', 2, 1617);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (119, 'Ortiz', 'Diane', 'Professor', 1, 1618);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (120, 'Gomez', 'Raymond', 'Doctor', 2, 1619);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (121, 'Murray', 'Jane', 'Master', 1, 1620);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (122, 'Freeman', 'Alan', 'Professor', 1, 1621);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (123, 'Wells', 'Jessica', 'Doctor', 1, 1622);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (124, 'Webb', 'Douglas', 'Master', 1, 1623);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (125, 'Simpson', 'Angela', 'Professor', 1, 1624);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (126, 'Stevens', 'Wayne', 'Doctor', 1, 1625);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (127, 'Tucker', 'Rachel', 'Master', 2, 1626);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (128, 'Hunter', 'Keith', 'Professor', 1, 1627);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (129, 'Hicks', 'Debra', 'Doctor', 1, 1628);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (130, 'Crawford', 'Harold', 'Master', 3, 1629);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (131, 'Henry', 'Theresa', 'Professor', 3, 1630);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (132, 'Boyd', 'Roy', 'Doctor', 1, 1631);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (133, 'Mason', 'Julia', 'Master', 2, 1632);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (134, 'Morales', 'Albert', 'Professor', 3, 1633);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (135, 'Kennedy', 'Teresa', 'Doctor', 1, 1634);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (136, 'Warren', 'Gerald', 'Master', 1, 1635);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (137, 'Dixon', 'Kathryn', 'Professor', 1, 1636);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (138, 'Ramos', 'Willie', 'Doctor', 1, 1637);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (139, 'Reyes', 'Sharon', 'Master', 1, 1638);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (140, 'Burns', 'Peter', 'Professor', 3, 1639);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (141, 'Gordon', 'Janet', 'Doctor', 1, 1640);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (142, 'Shaw', 'Carl', 'Master', 2, 1641);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (143, 'Holmes', 'Louise', 'Professor', 1, 1642);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (144, 'Rice', 'Ralph', 'Doctor', 1, 1643);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (145, 'Robertson', 'Christina', 'Master', 2, 1644);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (146, 'Hunt', 'Johnny', 'Professor', 3, 1645);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (147, 'Black', 'Emma', 'Doctor', 1, 1646);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (148, 'Daniels', 'Scott', 'Master', 2, 1647);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (149, 'Palmer', 'Ann', 'Professor', 3, 1648);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (150, 'Mills', 'Benjamin', 'Doctor', 2, 1649);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (151, 'Nichols', 'Cheryl', 'Master', 2, 1650);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (152, 'Grant', 'Walter', 'Professor', 3, 1651);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (153, 'Knight', 'Helen', 'Doctor', 1, 1652);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (154, 'Ferguson', 'Patrick', 'Master', 2, 1653);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (155, 'Rose', 'Katherine', 'Professor', 3, 1654);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (156, 'Stone', 'Jack', 'Doctor', 1, 1655);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (157, 'Hawkins', 'Alice', 'Master', 1, 1656);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (158, 'Dunn', 'Henry', 'Professor', 1, 1657);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (159, 'Perkins', 'Marilyn', 'Doctor', 1, 1658);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (160, 'Hudson', 'Jose', 'Master', 2, 1659);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (161, 'Spencer', 'Brenda', 'Professor', 1, 1660);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (162, 'Gardner', 'Louis', 'Doctor', 1, 1661);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (163, 'Stephens', 'Lillian', 'Master', 1, 1662);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (164, 'Payne', 'Russell', 'Professor', 3, 1663);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (165, 'Pierce', 'Elizabeth', 'Doctor', 1, 1664);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (166, 'Berry', 'Jimmy', 'Master', 1, 1665);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (167, 'Matthews', 'Kimberly', 'Professor', 3, 1666);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (168, 'Arnold', 'Joe', 'Doctor', 1, 1667);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (169, 'Wagner', 'Stephanie', 'Master', 2, 1668);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (170, 'Willis', 'Larry', 'Professor', 1, 1669);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (171, 'Ray', 'Carol', 'Doctor', 2, 1670);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (172, 'Watkins', 'David', 'Master', 1, 1671);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (173, 'Olson', 'Lauren', 'Professor', 1, 1672);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (174, 'Carroll', 'Jeremy', 'Doctor', 1, 1673);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (175, 'Duncan', 'Marilyn', 'Master', 2, 1674);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (176, 'Snyder', 'Bobby', 'Professor', 2, 1675);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (177, 'Hart', 'Julie', 'Doctor', 1, 1676);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (178, 'Cunningham', 'Jeffrey', 'Master', 1, 1677);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (179, 'Bradley', 'Christina', 'Professor', 3, 1678);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (180, 'Lane', 'Gerald', 'Doctor', 1, 1679);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (181, 'Andrews', 'Sara', 'Master', 1, 1680);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (182, 'Ruiz', 'Billy', 'Professor', 1, 1681);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (183, 'Harper', 'Laura', 'Doctor', 2, 1682);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (184, 'Fox', 'Roger', 'Master', 1, 1683);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (185, 'Riley', 'Kathryn', 'Professor', 3, 1684);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (186, 'Armstrong', 'Bruce', 'Doctor', 1, 1685);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (187, 'Carpenter', 'Denise', 'Master', 1, 1686);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (188, 'Weaver', 'Phillip', 'Professor', 3, 1687);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (189, 'Greene', 'Kelly', 'Doctor', 1, 1688);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (190, 'Lawrence', 'Carl', 'Master', 2, 1689);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (191, 'Elliott', 'Margaret', 'Professor', 1, 1690);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (192, 'Chavez', 'Raymond', 'Doctor', 1, 1691);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (193, 'Sims', 'Shirley', 'Master', 1, 1692);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (194, 'Austin', 'Joe', 'Professor', 1, 1693);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (195, 'Peters', 'Theresa', 'Doctor', 1, 1694);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (196, 'Kelley', 'Jack', 'Master', 2, 1695);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (197, 'Franklin', 'Debra', 'Professor', 1, 1696);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (198, 'Lawson', 'Roy', 'Doctor', 1, 1697);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (199, 'Fields', 'Jessica', 'Master', 1, 1698);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (200, 'Gutierrez', 'Albert', 'Professor', 3, 1699);
commit;
prompt 200 records committed...
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (201, 'Ryan', 'Angela', 'Doctor', 1, 1700);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (202, 'Schmidt', 'Ralph', 'Master', 1, 1701);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (203, 'Carr', 'Samantha', 'Professor', 3, 1702);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (204, 'Vasquez', 'Harry', 'Doctor', 1, 1703);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (205, 'Castillo', 'Linda', 'Master', 1, 1704);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (206, 'Wheeler', 'Henry', 'Professor', 1, 1705);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (208, 'Oliver', 'Mark', 'Master', 1, 1707);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (209, 'Montgomery', 'Amy', 'Professor', 1, 1708);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (210, 'Richards', 'Johnny', 'Doctor', 1, 1709);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (211, 'Williamson', 'Lori', 'Master', 2, 1710);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (212, 'Johnston', 'Billy', 'Professor', 1, 1711);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (213, 'Banks', 'Heather', 'Doctor', 1, 1712);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (214, 'Meyer', 'Frank', 'Master', 1, 1713);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (216, 'McCoy', 'Joshua', 'Doctor', 1, 1715);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (217, 'Howell', 'Diana', 'Master', 2, 1716);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (218, 'Alvarez', 'Aaron', 'Professor', 3, 1717);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (219, 'Morrison', 'Rachel', 'Doctor', 1, 1718);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (220, 'Hansen', 'Eric', 'Master', 1, 1719);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (221, 'Fernandez', 'Denise', 'Professor', 3, 1720);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (222, 'Garza', 'George', 'Doctor', 1, 1721);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (223, 'Hughes', 'Paula', 'Master', 1, 1722);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (224, 'Greer', 'Phillip', 'Professor', 1, 1723);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (225, 'Burke', 'Kelly', 'Doctor', 1, 1724);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (226, 'Casey', 'Peter', 'Master', 2, 1725);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (227, 'Parker', 'Joan', 'Professor', 1, 1726);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (228, 'Hamilton', 'Howard', 'Doctor', 1, 1727);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (229, 'Graham', 'Teresa', 'Master', 2, 1728);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (230, 'Reyes', 'Ronald', 'Professor', 2, 1729);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (231, 'Ford', 'Diana', 'Doctor', 1, 1730);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (232, 'Spencer', 'Patrick', 'Master', 2, 1731);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (233, 'Willis', 'Stephanie', 'Professor', 2, 1732);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (234, 'Duncan', 'Russell', 'Doctor', 1, 1733);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (235, 'Murray', 'Ann', 'Master', 2, 1734);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (236, 'Johnston', 'Louis', 'Professor', 1, 1735);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (237, 'Reyes', 'George', 'Doctor', 1, 1736);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (238, 'Oliver', 'Dorothy', 'Master', 2, 1737);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (239, 'Peterson', 'Christophe', 'Professor', 1, 1738);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (240, 'Fields', 'Jessica', 'Doctor', 1, 1739);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (241, 'Jacobs', 'Albert', 'Master', 1, 1740);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (242, 'Moore', 'Kimberly', 'Professor', 1, 1741);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (243, 'Diaz', 'Edward', 'Doctor', 1, 1742);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (244, 'White', 'Carol', 'Master', 2, 1743);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (245, 'Cook', 'Gerald', 'Professor', 1, 1744);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (246, 'Watson', 'Marilyn', 'Doctor', 1, 1745);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (247, 'Bryant', 'Arthur', 'Master', 2, 1746);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (248, 'Garcia', 'Amy', 'Professor', 1, 1747);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (249, 'Jenkins', 'Raymond', 'Doctor', 1, 1748);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (250, 'Perry', 'Angela', 'Master', 1, 1749);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (251, 'Hughes', 'Adam', 'Professor', 1, 1750);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (252, 'Simmons', 'Diane', 'Doctor', 1, 1751);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (253, 'Cruz', 'Lawrence', 'Master', 2, 1752);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (254, 'Clark', 'Karen', 'Professor', 3, 1753);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (255, 'Adams', 'John', 'Doctor', 1, 1754);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (256, 'Nelson', 'Lisa', 'Master', 2, 1755);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (257, 'Morris', 'Paul', 'Professor', 1, 1756);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (258, 'Long', 'Margaret', 'Doctor', 1, 1757);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (259, 'Flores', 'David', 'Master', 1, 1758);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (260, 'Bailey', 'Nancy', 'Professor', 1, 1759);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (261, 'Ramirez', 'James', 'Doctor', 1, 1760);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (262, 'Stewart', 'Susan', 'Master', 1, 1761);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (263, 'Reed', 'Robert', 'Professor', 3, 1762);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (264, 'Brown', 'Mary', 'Doctor', 1, 1763);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (265, 'Green', 'Richard', 'Master', 1, 1764);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (266, 'Hall', 'Linda', 'Professor', 3, 1765);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (267, 'Wood', 'Thomas', 'Doctor', 2, 1766);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (268, 'Jackson', 'Betty', 'Master', 2, 1767);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (269, 'Anderson', 'Donald', 'Professor', 1, 1768);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (270, 'Phillips', 'Barbara', 'Doctor', 2, 1769);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (271, 'Scott', 'Christophe', 'Master', 1, 1770);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (272, 'White', 'Patricia', 'Professor', 3, 1771);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (273, 'Jones', 'Larry', 'Doctor', 1, 1772);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (274, 'Moore', 'Sandra', 'Master', 2, 1773);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (275, 'Davis', 'Joseph', 'Professor', 2, 1774);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (276, 'Evans', 'Mary', 'Doctor', 1, 1775);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (277, 'Lopez', 'James', 'Master', 2, 1776);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (278, 'Walker', 'Charles', 'Professor', 1, 1777);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (279, 'Martinez', 'Susan', 'Doctor', 1, 1778);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (280, 'Robinson', 'Daniel', 'Master', 2, 1779);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (281, 'Clark', 'Barbara', 'Professor', 1, 1780);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (282, 'Lewis', 'Joseph', 'Doctor', 1, 1781);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (283, 'Harris', 'Jennifer', 'Master', 1, 1782);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (284, 'King', 'David', 'Professor', 1, 1783);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (285, 'Lee', 'Linda', 'Doctor', 1, 1784);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (286, 'Young', 'John', 'Master', 1, 1785);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (287, 'Hall', 'Betty', 'Professor', 3, 1786);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (288, 'Allen', 'Thomas', 'Doctor', 1, 1787);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (289, 'Wright', 'Michael', 'Master', 2, 1788);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (290, 'Hernandez', 'Susan', 'Professor', 3, 1789);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (291, 'Thompson', 'James', 'Doctor', 1, 1790);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (292, 'Jackson', 'Mary', 'Master', 2, 1791);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (293, 'Martin', 'Robert', 'Professor', 3, 1792);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (294, 'Garcia', 'Patricia', 'Doctor', 1, 1793);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (295, 'Martinez', 'Richard', 'Master', 1, 1794);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (296, 'Robinson', 'Jennifer', 'Professor', 1, 1795);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (297, 'Clark', 'Michael', 'Doctor', 1, 1796);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (298, 'Rodriguez', 'Elizabeth', 'Master', 2, 1797);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (299, 'Lewis', 'Charles', 'Professor', 3, 1798);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (300, 'Harris', 'Linda', 'Doctor', 1, 1799);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (301, 'King', 'Barbara', 'Master', 2, 1800);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (302, 'Lee', 'James', 'Professor', 3, 1801);
commit;
prompt 300 records committed...
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (303, 'Young', 'Patricia', 'Doctor', 1, 1802);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (304, 'Walker', 'Christophe', 'Master', 2, 1803);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (305, 'Hall', 'Thomas', 'Professor', 1, 1804);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (306, 'Allen', 'Betty', 'Doctor', 1, 1805);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (307, 'Wright', 'David', 'Master', 1, 1806);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (308, 'Hernandez', 'Jennifer', 'Professor', 1, 1807);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (309, 'Thompson', 'John', 'Doctor', 1, 1808);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (310, 'Jackson', 'Robert', 'Master', 1, 1809);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (311, 'Martin', 'Michael', 'Professor', 1, 1810);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (312, 'Gonzalez', 'Linda', 'Doctor', 1, 1811);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (313, 'Lopez', 'Charles', 'Master', 1, 1812);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (314, 'Walker', 'Susan', 'Professor', 3, 1813);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (315, 'Martinez', 'James', 'Doctor', 1, 1814);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (316, 'Robinson', 'Joseph', 'Master', 1, 1815);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (317, 'Clark', 'Patricia', 'Professor', 2, 1816);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (318, 'Lewis', 'Thomas', 'Doctor', 1, 1817);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (319, 'Harris', 'Jennifer', 'Master', 1, 1818);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (320, 'King', 'David', 'Professor', 1, 1819);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (321, 'Lee', 'Linda', 'Doctor', 1, 1820);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (322, 'Young', 'John', 'Master', 2, 1821);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (323, 'Walker', 'Betty', 'Professor', 1, 1822);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (324, 'Hall', 'Michael', 'Doctor', 1, 1823);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (325, 'Allen', 'Susan', 'Master', 1, 1824);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (326, 'Wright', 'Christophe', 'Professor', 1, 1825);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (327, 'Hernandez', 'James', 'Doctor', 1, 1826);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (328, 'Thompson', 'Patricia', 'Master', 1, 1827);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (329, 'Jackson', 'Charles', 'Professor', 1, 1828);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (330, 'Martin', 'Linda', 'Doctor', 1, 1829);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (331, 'Garcia', 'Joseph', 'Master', 1, 1830);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (332, 'Martinez', 'David', 'Professor', 1, 1831);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (333, 'Robinson', 'Betty', 'Doctor', 1, 1832);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (334, 'Clark', 'Michael', 'Master', 2, 1833);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (335, 'Lewis', 'Susan', 'Professor', 3, 1834);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (336, 'Harris', 'Charles', 'Doctor', 1, 1835);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (337, 'King', 'Patricia', 'Master', 2, 1836);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (338, 'Lee', 'James', 'Professor', 1, 1837);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (339, 'Young', 'Thomas', 'Doctor', 1, 1838);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (340, 'Walker', 'Linda', 'Master', 2, 1839);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (341, 'Hall', 'John', 'Professor', 3, 1840);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (342, 'Allen', 'Michael', 'Doctor', 1, 1841);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (343, 'Wright', 'David', 'Master', 1, 1842);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (344, 'Hernandez', 'Patricia', 'Professor', 1, 1843);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (345, 'Thompson', 'Robert', 'Doctor', 1, 1844);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (346, 'Jackson', 'Susan', 'Master', 2, 1845);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (347, 'Martin', 'James', 'Professor', 3, 1846);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (348, 'Gonzalez', 'Joseph', 'Doctor', 2, 1847);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (349, 'Lopez', 'Charles', 'Master', 2, 1848);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (350, 'Walker', 'Patricia', 'Professor', 1, 1849);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (351, 'Martinez', 'Linda', 'Doctor', 1, 1850);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (352, 'Robinson', 'Thomas', 'Master', 2, 1851);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (353, 'Clark', 'John', 'Professor', 1, 1852);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (354, 'Lewis', 'Michael', 'Doctor', 1, 1853);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (355, 'Harris', 'Betty', 'Master', 1, 1854);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (356, 'King', 'David', 'Professor', 1, 1855);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (357, 'Lee', 'Linda', 'Doctor', 1, 1856);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (358, 'Young', 'James', 'Master', 2, 1857);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (359, 'Walker', 'Michael', 'Professor', 1, 1858);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (360, 'Hall', 'John', 'Doctor', 1, 1859);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (361, 'Allen', 'Patricia', 'Master', 2, 1860);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (362, 'Wright', 'Susan', 'Professor', 3, 1861);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (363, 'Hernandez', 'Charles', 'Doctor', 1, 1862);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (364, 'Thompson', 'David', 'Master', 1, 1863);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (365, 'Jackson', 'Linda', 'Professor', 3, 1864);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (366, 'Martin', 'Michael', 'Doctor', 1, 1865);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (367, 'Garcia', 'Betty', 'Master', 1, 1866);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (368, 'Martinez', 'James', 'Professor', 3, 1867);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (369, 'Robinson', 'Joseph', 'Doctor', 1, 1868);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (370, 'Clark', 'Patricia', 'Master', 2, 1869);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (371, 'Lewis', 'Thomas', 'Professor', 2, 1870);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (372, 'Harris', 'John', 'Doctor', 1, 1871);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (373, 'King', 'Linda', 'Master', 1, 1872);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (374, 'Lee', 'Michael', 'Professor', 1, 1873);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (375, 'Young', 'David', 'Doctor', 1, 1874);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (376, 'Walker', 'Susan', 'Master', 2, 1875);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (377, 'Hall', 'Betty', 'Professor', 1, 1876);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (378, 'Allen', 'James', 'Doctor', 1, 1877);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (379, 'Wright', 'Patricia', 'Master', 1, 1878);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (380, 'Hernandez', 'Robert', 'Professor', 1, 1879);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (381, 'Thompson', 'Michael', 'Doctor', 2, 1880);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (382, 'Jackson', 'David', 'Master', 1, 1881);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (383, 'Martin', 'Linda', 'Professor', 3, 1882);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (384, 'Garcia', 'James', 'Doctor', 1, 1883);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (385, 'Martinez', 'Joseph', 'Master', 2, 1884);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (386, 'Robinson', 'Charles', 'Professor', 1, 1885);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (387, 'Clark', 'Patricia', 'Doctor', 1, 1886);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (388, 'Lewis', 'John', 'Master', 1, 1887);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (389, 'Harris', 'Michael', 'Professor', 1, 1888);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (390, 'King', 'Betty', 'Doctor', 1, 1889);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (391, 'Lee', 'David', 'Master', 1, 1890);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (392, 'Young', 'Linda', 'Professor', 3, 1891);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (393, 'Walker', 'James', 'Doctor', 1, 1892);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (394, 'Hall', 'Patricia', 'Master', 2, 1893);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (395, 'Allen', 'Charles', 'Professor', 1, 1894);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (396, 'Wright', 'Michael', 'Doctor', 1, 1895);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (397, 'Hernandez', 'Susan', 'Master', 2, 1896);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (398, 'Thompson', 'John', 'Professor', 3, 1897);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (399, 'Jackson', 'Robert', 'Doctor', 1, 1898);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (400, 'Martin', 'Linda', 'Master', 2, 1899);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (207, 'Chapman', 'Elizabeth', 'Doctor', 1, 1706);
insert into TEACHER (teacher_id, l_name, f_name, title, rank, employee_id)
values (215, 'Bishop', 'Dorothy', 'Professor', 1, 1714);
commit;
prompt 400 records loaded
...
alter table BUDGET enable constraint SYS_C008710;
prompt Enabling foreign key constraints for TEACHER...
alter table TEACHER enable constraint FK_EMPLOYEE;
prompt Enabling foreign key constraints for CLASS...
alter table CLASS enable constraint SYS_C008668;
alter table CLASS enable constraint SYS_C008669;
alter table CLASS enable constraint SYS_C008670;
prompt Enabling foreign key constraints for INVOICE...
alter table INVOICE enable constraint SYS_C008715;
prompt Enabling foreign key constraints for ORDERS...
alter table ORDERS enable constraint SYS_C008719;
alter table ORDERS enable constraint SYS_C008720;
alter table ORDERS enable constraint SYS_C008721;
prompt Enabling foreign key constraints for PAYMENT...
alter table PAYMENT enable constraint SYS_C008724;
prompt Enabling foreign key constraints for SCHEDULE...
alter table SCHEDULE enable constraint SYS_C008684;
alter table SCHEDULE enable constraint SYS_C008701;
prompt Enabling foreign key constraints for STUDENTCLASS...
alter table STUDENTCLASS enable constraint STUDENTCLASS_STUDENTCLASS__FK;
alter table STUDENTCLASS enable constraint SYS_C008700;
prompt Enabling foreign key constraints for TEACHASSIGN...
alter table TEACHASSIGN enable constraint SYS_C008693;
alter table TEACHASSIGN enable constraint SYS_C008694;
